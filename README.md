...
**Synthetic Scene-Text Image Khmer Script Samples**
![Synthetic Scene-Text Khmer Script Samples](samples_khmer.png "Synthetic Samples")
...
```
pygame, opencv, PIL (Image), numpy, matplotlib, h5py, scipy
```
